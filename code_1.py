...
s = r'C:\Users\shash\OneDrive\Desktop\KidneyStoneDetection-main\KidneyStoneDetection-main\images\final_normal1.jpeg'
s = r'C:\Users\shash\OneDrive\Desktop\KidneyStoneDetection-main\KidneyStoneDetection-main\images\final_normal1.jpeg'
img = cv2.imread(s,0)
...
def pre_processing(img):
    ...
    img_rm_small = morphology.remove_small_objects(img, min_size=5, connectivity=2)
    plt.subplot(2,2,1)
